...
const birdeyeProjection = {
  ...
  attribution: {
    ...
    branch: "main",
    head: "722fc238",
    observedAt: "2026-09-18T18:28:00Z",
  },
  git: {
    isRepository: true,
    branch: "main",
  ...
  alignment: {
    ...
    observedHead: "722fc238",
    evidenceLevel: "PROVEN",
    reason: "Workspace has advanced past documented source_head with canonical read-only Git capabilities (git.status, git.diff_summary)",
  },
  verdict: "REVIEW",
