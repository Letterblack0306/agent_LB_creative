...
const birdeyeProjection = {
  ...
  attribution: {
    ...
    branch: "main",
    head: "3a4b1082",
    observedAt: "2026-09-18T17:50:00Z",
  },
  git: {
    isRepository: true,
    branch: "main",
  ...
  alignment: {
    ...
    observedHead: "3a4b1082",
    evidenceLevel: "PROVEN",
    reason: "Workspace has advanced past documented source_head with root-to-leaf cleanup, runtime-ui rebuild, and disposable artifact removal",
  },
  verdict: "REVIEW",
