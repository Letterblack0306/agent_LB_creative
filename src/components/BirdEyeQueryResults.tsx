...
const birdeyeProjection = {
  ...
  attribution: {
    ...
    branch: "main",
    head: "2cbb187d",
    observedAt: "2026-09-18T17:09:00Z",
  },
  git: {
    isRepository: true,
    branch: "main",
  ...
  alignment: {
    ...
    observedHead: "2cbb187d",
    evidenceLevel: "PROVEN",
    reason: "Workspace has advanced past documented source_head with documentation updates and external PR merge boundary recording",
  },
  verdict: "REVIEW",
