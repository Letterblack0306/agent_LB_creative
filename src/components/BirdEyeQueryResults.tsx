...
const birdeyeProjection = {
  ...
  alignment: {
    ...
    observedHead: "dd2794df",
    evidenceLevel: "PROVEN",
    reason: "Workspace has advanced past documented source_head with memory guard fixes, secret scanner fixes, and workspace state cleanup",
  },
  verdict: "REVIEW",
